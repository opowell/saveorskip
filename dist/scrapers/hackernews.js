      ...
      f = function(t, n, r) {
        ...
        for (s in (v && (r = n), r))
          (l = ((a = !d && m && void 0 !== m[s]) ? m : r)[s]),
            (p = y && a ? c(l, e) : g && 'function' == typeof l ? c(Function.call, l) : l),
            m && u(m, s, l, t & f.U),
            b[s] != l && i(b, s, p),
            g && x[s] != l && (x[s] = l);
      };
  ...
  function(t, n, r) {
    ...
    var e = {
      ...
      getSources: function(t) {
        for (var n = document.querySelectorAll('.hnuser'), r = 0; r < n; r++) {
      ...
      getLinks: function(t) {
        for (var n = [], r = document.querySelectorAll('.storyLink'), o = 0; o < r.length; o++) {
