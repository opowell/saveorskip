  ...
  <div>
    ...
    >
      <template v-slot:header>
        <button :disabled="!profile.autoGenerated" @click="scrape" title="Open and scrape this profile for links.">Scrape</button>
        <button :disabled="!profile.autoGenerated" @click="openLink(true)" title="Open this profile in a new tab.">Open</button>
...
export default {
  ...
  methods: {
    ...
    async exportProfile() {
      ...
      await idb.loadLinks({ profileId: this.profileId });
