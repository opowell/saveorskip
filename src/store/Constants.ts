...
export const dbPromise = openDB(DB_NAME, DB_VERSION, {
  async upgrade(db, oldVersion, newVersion, transaction) {
    if (oldVersion === 0) {
      ...
      let profilesStore = db.createObjectStore(STORE_PROFILES, { keyPath: 'id', autoIncrement: true });
      profilesStore.createIndex(INDEX_PROFILES_AUTOGENERATED, FIELD_PROFILES_AUTOGENERATED, { unique: false });
